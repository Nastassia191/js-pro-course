import PostsFilterType, { PostsFilterAction, PostsFilterActionTypes, PostsOrder } from "./PostsFilterTypes";
...
export const PostsFilterRuducer = (state: PostsFilterType, action: PostsFilterAction): PostsFilterType => {
  switch (action.type) {
    ...
    case PostsFilterActionTypes.SET_LIMIT_TYPE:
      return {
        ...state, page: 1, limit: action.payload
      }
    case PostsFilterActionTypes.SET_ORDER_TYPE:
      return {
        ...state, page: 1, ordering: action.payload
      }
